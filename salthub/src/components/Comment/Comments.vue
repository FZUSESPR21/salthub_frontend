      ...
      <el-container>
        <el-aside width="200px">
          <div style="padding-left:20px;padding-top:20px;">
            ...
            <div style="font-size:20px;width:100%;padding:0;margin:0;word-break: break-all;white-space: normal;line-height:20px;position:relative;text-align:center">{{comment.author}}</div>
          </div>
        </el-aside>
        <el-container>
